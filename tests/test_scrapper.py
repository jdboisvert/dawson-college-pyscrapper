...
from dawson_college_pyscrapper.models import Program, ProgramPageData

from dawson_college_pyscrapper.scrapper import get_program_details, get_programs, get_total_number_of_faculty, get_total_number_of_students
...
def test_get_total_number_of_students(requests_mock):
    ...
    """
    requests_mock.get("https://www.google.com/search?q=dawson+college+number+of+students&stick=H4sIAAAAAAAAAOPgE-LUz9U3MLTMKjbV0s8ot9JPzs_JSU0uyczP088vSk_My6xKBHGKrfJKc5NSixTy0xSKS0pTUvNKihexKqYklhfn5ymANaWnKmCqAQDR74rvYgAAAA&sa=X&ved=2ahUKEwjXvq6b97XjAhUaQ80KHTRfCb8Q6BMoADAgegQIGhAC&biw=1156&bih=754", text=example_html)
